 ...
 * of this value object you may modify the generated sub-class of this class - RelatedItemDetails.as.
 */
...
[ExcludeClass]
public class _Super_RelatedItemDetails extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _RelatedItemDetailsEntityMetadata;
    ...
    public function _Super_RelatedItemDetails()
    {
        _model = new _RelatedItemDetailsEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get relatedItemClass() : int
    {
        return _internal_relatedItemClass;
    }
    ...
    public function set relatedItemClass(value:int) : void
    {
        ...
        if (oldValue !== value)
        {
            _internal_relatedItemClass = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "relatedItemClass", oldValue, _internal_relatedItemClass));
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _RelatedItemDetailsEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _RelatedItemDetailsEntityMetadata) : void
    {
        var oldValue : _RelatedItemDetailsEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
